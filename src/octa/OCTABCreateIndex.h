...
#define CREATE_INDEX_ACCOUNT_PK "CREATE UNIQUE INDEX account_pk \n" \
                                "ON account ( account_id ) \n"      \
                                "TABLESPACE %s"

#define CREATE_INDEX_TELLER_PK "CREATE UNIQUE INDEX teller_pk \n" \
                               "ON teller ( teller_id ) \n"       \
                               "TABLESPACE %s"

#define CREATE_INDEX_BRANCH_PK "CREATE UNIQUE INDEX branch_pk \n" \
                               "ON branch ( branch_id ) \n"       \
                               "TABLESPACE %s"

#define CREATE_INDEX_INPUT {                                        \
